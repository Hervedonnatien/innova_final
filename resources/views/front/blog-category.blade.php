...
@section('banner')
        ...
        <div class="breadcrum-area">
            ...
            <ul class="shape-group-8 list-unstyled">
                ...
                <li class="shape shape-2" data-sal="slide-left" data-sal-duration="500" data-sal-delay="200"><img src="{{ asset('assets/media/others/bubble-10.png') }}" alt="Bubble"></li>
        ...
        <section class="section-padding-equal">
            <div class="container">
                <div class="row row-40">
                    <div class="col-lg-8">
                        <div class="blog-grid">
                            <h3 class="title"><a href="{{ route('blog') }}">How to Increase Your ROI Through scientific SEM?</a></h3>
                            <div class="author">
                            ...
                            <div class="post-thumbnail">
                                <a href="{{ route('blog') }}"><img src="{{ asset('assets/media/blog/blog-3.png') }}" alt="Blog"></a>
                            </div>
                            ...
                            <a href="{{ route('blog') }}" class="axil-btn btn-borderd btn-large">Read More</a>
                        </div>
                        <div class="blog-grid blog-without-thumb">
                            <h3 class="title"><a href="{{ route('blog') }}">Twice Profit Than Before You Ever Got</a></h3>
                            <div class="author">
                                <div class="info">
                                    <h6 class="author-name">Theresa Underwood</h6>
                                    <ul class="blog-meta list-unstyled">
                        ...
                        <div class="blog-grid">
                            <h3 class="title"><a href="{{ route('blog') }}">Cloud Hosting Growing Faster Ever</a></h3>
                            <div class="author">
                                <div class="author-thumb">
                                    <img src="{{ asset('assets/media/blog/author-2.png') }}" alt="Blog Author">
                                </div>
                                <div class="info">
                                    <h6 class="author-name">Theresa Underwood</h6>
                                    <ul class="blog-meta list-unstyled">
                            ...
                            <div class="post-thumbnail">
                                <a href="{{ route('blog') }}"><img src="{{ asset('assets/media/blog/blog-4.png') }}" alt="Blog"></a>
                            </div>
                            <p>Want to know the one thing that every successful digital marketer does first to ensure they get the biggest return on their marketing budget? It’s simple: goal-setting. This is an absolutely essential practice for any digital marketer who knows how to execute their campaigns...</p>
                            <a href="{{ route('blog') }}" class="axil-btn btn-borderd btn-large">Read More</a>
                        </div>
                        <div class="blog-grid blog-without-thumb">
                            <blockquote>
                                <h5 class="title"><a href="{{ route('blog') }}">“ The goal of a designer is to listen, observe, understand, sympathize, empathize, synthesize, and glean insights that enable him or her to make the invisible visible. ”</a></h5>
                            </blockquote>
                            <div class="author">
                                <div class="info">
                                    <h6 class="author-name">Theresa Underwood</h6>
                        ...
                        <div class="blog-grid blog-thumb-slide">
                            <h3 class="title"><a href="{{ route('blog') }}">eCommerce Marketing Statistics You Should Know in 2021.</a></h3>
                            <div class="author">
                                <div class="author-thumb">
                                    <img src="{{ asset('assets/media/blog/author-2.png') }}" alt="Blog Author">
                                </div>
                        ...
                        <div class="blog-grid mb-0">
                            <h3 class="title"><a href="{{ route('blog') }}">Follow your own design process, whatever gets you to the outcome.</a></h3>
                            <div class="author">
                                <div class="author-thumb">
                                    <img src="{{ asset('assets/media/blog/author-2.png') }}" alt="Blog Author">
                                </div>
                        ...
                        <div class="axil-sidebar">
                            ...
                            <div class="widget widget-categories">
                                ...
                                <ul class="category-list list-unstyled">
                                    <li><a href="blog-category.blade.php">Agency news</a></li>
                                    <li><a href="blog-category.blade.php">Digital Marketing</a></li>
                                    <li><a href="blog-category.blade.php">Information technology</a></li>
                                    <li><a href="blog-category.blade.php">New ideas</a></li>
                                    <li><a href="blog-category.blade.php">Uncategorized</a></li>
                                    <li><a href="blog-category.blade.php">Marketing &amp; branding</a></li>
                                </ul>
                            </div>
